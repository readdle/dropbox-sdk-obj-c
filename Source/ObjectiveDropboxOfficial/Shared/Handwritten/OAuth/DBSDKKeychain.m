...
+ (NSArray<NSArray<NSString *> *> *)v1TokensDataIOSCore {
  ...
  if (status == noErr) {
    ...
    for (NSDictionary<NSString *, id> *dict in dataResultDict) {
      ...
      if (foundData != nil) {
        NSDictionary *unarchivedFoundData = [NSKeyedUnarchiver unarchivedObjectOfClass:NSDictionary.class fromData:foundData error:nil];
    ...
    for (NSDictionary<NSString *, id> *dict in dataResultDict) {
      ...
      if (foundData != nil) {
        NSDictionary *credentialsDictionary =
          [NSKeyedUnarchiver unarchivedObjectOfClass:NSDictionary.class fromData:foundData error:nil][kV1SyncAccountCredentialsKey];
